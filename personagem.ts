...
function criarPersonagem(): Personagem {
    ...
    let tipo = prompt("Selecione o tipo do personagem (Mago, Guerreira, Assassino, Arqueiro):");

    // Verificar se o tipo é válido
    while (![Personagem.MAGO, Personagem.GUERREIRA, Personagem.ASSASSINO, Personagem.ARQUEIRO].includes(tipo)) {
